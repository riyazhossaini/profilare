...
export function ContentHero({ name, username, headline, statement, stats }: { name: string; username: string; headline: string; statement: string; stats: Array<{ label: string; value: string }> }) {
  return (
