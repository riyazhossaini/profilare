        ...
        <div className="flex items-center gap-2">
          {onEdit ? (
            <button
              ...
              className="rounded-full border border-zinc-200 bg-white p-1.5 text-zinc-700 opacity-0 transition group-hover:opacity-100 hover:bg-zinc-50"
            >
              <Pencil className="h-3.5 w-3.5" />
            </button>
          ) : null}
          <ArrowRight className="mt-0.5 h-5 w-5 shrink-0 text-zinc-400 transition-transform duration-300 group-hover:translate-x-1 group-hover:text-violet-600" />
        </div>
      </div>
    </Link>
  );
