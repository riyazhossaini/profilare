...
export function PersonalProjectsSection({ username, items, onEdit, onDelete }: { username: string; items: ExperienceItem[]; onEdit?: (slug: string) => void; onDelete?: (slug: string) => void }) {
  return (
