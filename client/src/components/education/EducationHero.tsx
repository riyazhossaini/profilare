...
export function EducationHero({ name, username, headline, statement, avatarText = "RH", avatarUrl = "" }: { name: string; username: string; headline: string; statement: string; avatarText?: string; avatarUrl?: string }) {
