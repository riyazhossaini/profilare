...
export function AboutSummaryCard({ items }: AboutSummaryCardProps) {
  return (
    <motion.section
    ...
    >
      <h2 className="text-2xl font-bold tracking-tight text-zinc-900">About Summary</h2>
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
        {items.map((item) => (
          <article key={item.label} className="rounded-2xl border border-violet-100 bg-gradient-to-br from-white to-violet-50/40 p-4">
