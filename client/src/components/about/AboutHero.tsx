...
export function AboutHero({ name, username, headline, location, statement, avatarText = "RH", avatarUrl = "" }: AboutHeroProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-violet-500 to-indigo-600 text-3xl font-bold text-white shadow-xl">
