...
export function StartupProjectsSection({ username, items, onEdit, onDelete }: { username: string; items: ProjectItem[]; onEdit?: (slug: string) => void; onDelete?: (slug: string) => void }) {
  return (
